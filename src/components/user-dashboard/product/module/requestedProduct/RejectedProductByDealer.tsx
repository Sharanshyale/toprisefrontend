...
export default function RejectedProductByDealer({
  searchQuery,
}: {
  searchQuery: string;
}) {
  ...
  // Only show products with live_status 'Rejected'
  let filtered = paginatedProducts.filter((product: any) => product.live_status === "Rejected");
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem className="cursor-pointer" onClick={() => {
                // Example: Approve all selected rejected products
              ...
              <DropdownMenuItem className="cursor-pointer" onClick={() => {
                // Example: Deactivate all selected rejected products
                selectedProducts.forEach(async (id) => {
